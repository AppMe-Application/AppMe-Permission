...
import com.appme.story.engine.app.analytics.permission.Action;
import com.appme.story.engine.app.analytics.permission.AndPermission;
import com.appme.story.engine.app.analytics.permission.runtime.Permission;
import com.appme.story.engine.app.analytics.permission.runtime.PermissionDef;
import com.appme.story.engine.app.analytics.permission.task.TaskExecutor;
import com.appme.story.engine.app.analytics.rationals.InstallRationale;
import com.appme.story.engine.app.analytics.rationals.NotifyListenerRationale;
import com.appme.story.engine.app.analytics.rationals.NotifyRationale;
import com.appme.story.engine.app.analytics.rationals.OverlayRationale;
import com.appme.story.engine.app.analytics.rationals.RuntimeRationale;
import com.appme.story.engine.app.analytics.rationals.WriteSettingRationale;
import com.appme.story.engine.app.utils.FileUtils;
import com.appme.story.engine.app.utils.IOUtils;
...
public class ApplicationActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        AndPermission.with(this)
            ...
            .onDenied(new Action<List<String>>() {
                ...
                public void onAction(@NonNull List<String> permissions) {
                    ...
                    if (AndPermission.hasAlwaysDeniedPermission(ApplicationActivity.this, permissions)) {
                        showSettingDialog(ApplicationActivity.this, permissions);
                    }
                }
            })
            .start();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        switch (requestCode) {
            case REQUEST_CODE_SETTING: {
                    Toast.makeText(ApplicationActivity.this, R.string.message_setting_comeback, Toast.LENGTH_SHORT).show();
                    break;
                }
        }
    }
    ...
    private void writeApkForInstallPackage() {
        new TaskExecutor<File>(ApplicationActivity.this) {
            @Override
            protected File doInBackground(Void... voids) {
                try {
                    InputStream input = getAssets().open("android.apk");
                    File apk = new File(FileUtils.getExternalDir(AppController.get(), Environment.DIRECTORY_DOWNLOADS), "AndPermission.apk");
    ...
    private void showAlertWindow() {
        AppController.get().showLauncherView();
